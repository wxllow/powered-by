export interface Platform {
    ...
    description: string;
    url?: string;
    signifies?: string[]; // Other platforms that this platform implies usage of
...
export const platforms: { [key: string]: Platform } = {
    ...
    nextjs: {
        name: 'Next.js',
        description:
            'Next.js is a React framework for web applications with built-in server-side rendering and static site generation.',
    ...
    elementor: {
        name: 'Elementor',
        description:
            'Elementor is a WordPress page builder plugin for WordPress.',
    ...
    googlesitekit: {
        ...
        description:
            'Google Site Kit is a WordPress plugin that provides insights about how people find and use your site, how to improve, and monetize your content.',
